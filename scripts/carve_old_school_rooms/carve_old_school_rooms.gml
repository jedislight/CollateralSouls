/// @description carve_old_school_rooms(room_max, room_width_min, room_width_max, room_height_min, room_height_max, start_x, start_y)
/// @param room_max
...
/// @param  start_y
{
    ...
    repeat(room_max)
    {
        ...
        if(collision_rectangle(left, top, right, bottom, Floor, false, false) <= 0)
        {
            ...
            ds_list_clear(room_hubs_x);
            ds_list_clear(room_hubs_y);
